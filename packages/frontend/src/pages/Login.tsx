                    ...
                    {type === '注册' ? (
                        ...
                        >
                            <Stack>
                                ...
                                <TextInput required label='邮箱' placeholder='hello@bjbybbs.com' radius='md' {...registerForm.getInputProps('email')} />
                        ...
                        >
                            <Stack>
                                <TextInput required label='邮箱' placeholder='hello@bjbybbs.com' radius='md' {...loginForm.getInputProps('email')} />

                                <PasswordInput required label='密码' placeholder='您的密码（要保密！）' radius='md' {...loginForm.getInputProps('password')} />
                            </Stack>
